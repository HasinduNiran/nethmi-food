...
<section id="hero" style="position: relative;">
    ...
    <div class="hero container" style="position: relative; z-index: 1;">
        <div>
            <h1><strong><h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;">Food Yard By Nethmi</h1><span></span></strong></h1>
            <h1><strong style="color:white;">DINING & Fresh Juice BAR<span></span></strong></h1>
