...
try {
    ...
    // Adjusted query to match fetch_inventory_report.php
    $query = "SELECT 
...
<head>
    ...
    <title>Total Stock Inventory Report</title>
    <style>
        body {
...
<body onload="window.print()">
    <h1>Total Stock Inventory Report</h1>
            ...
            <tbody>
                <?php foreach ($data as $item): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($item['wastage']); ?></td>
