...
if (isset($_GET['hotel_type_id'])) {
    $hotel_type_id = $_GET['hotel_type_id'];
}
...
// If reference number is not passed but we have bill_id, try to get it from database
        ...
        <div class="kot-partition" id="main-kitchen">
            ...
            <table class="bill-info-tb">
                <thead>
                    ...
                    <tr>
                        <td><?php echo htmlspecialchars($serviceName); ?> Ref No: </td>
                        <td><?php echo htmlspecialchars($reference_number); ?></td>
                    </tr>
                    <?php endif; ?>
                </thead>
            </table>
