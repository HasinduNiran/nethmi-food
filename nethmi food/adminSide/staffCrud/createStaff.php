...
<div class="wrapper">
    ...
    <form method="POST" action="succ_create_staff.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input type="text" name="email" placeholder="user@gmail.com" class="form-control <?php echo !$emailErr ?: 'is-invalid'; ?>" id="email" required value="<?php echo $email; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="text" name="phone_number" placeholder="+761112233" class="form-control <?php echo !$phone_numberErr ?: 'is-invalid'; ?>" id="phone_number" required value="<?php echo $phone_number; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="password" name="password" placeholder="******" id="password" required class="form-control <?php echo !$password_err ?: 'is-invalid'; ?>" value="<?php echo $password; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
