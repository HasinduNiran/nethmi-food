            ...
            <div class="row center-middle">
                ...
                <div class="col-md-15" style="margin-left: 17rem; margin-top: 0rem;max-height: 700px; overflow-y: auto;">
                    <div class="row justify-content-center">
                        ...
                        $query = "SELECT * FROM restaurant_tables WHERE hoteltype = $id ORDER BY table_id;";
...
$doneItems = $rowst['done_items'] ?? 0; // Done items
    ...
    <a href="orderItem.php?bill_id=<?= $latestBillID; ?>&table_id=<?= $table_id; ?>&id=<?= $id; ?>"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                -->
                        <div class="col-md-3">
    <div class="alert alert-warning" style="color:black; background-color: gray;" role="alert" data-toggle="tooltip" data-placement="top" title="Tables That are Reserved">
        Not Assign Customer Yet
    </div>
</div>
