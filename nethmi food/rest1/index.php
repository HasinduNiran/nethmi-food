...
<head>
<meta charset="utf-8">
<title>MUM'S TOUCH - Restaurants HTML Template - Home </title>
<!-- Stylesheets -->
  ...
  <div class="page-wrapper"> 
                ...
                <div class="inner clearfix">
                    <div class="top-left clearfix">
                        <ul class="top-info clearfix">
                            <li><i class="icon far fa-map-marker-alt"></i>Gampaha City</li>
                            <li><i class="icon far fa-clock"></i> Daily : 8.00 am to 10.00 pm</li>
                        </ul>
                    </div>
                    <div class="top-right clearfix">
                        <ul class="top-info clearfix">
                            <li><a href="tel:+11234567890"><i class="icon far fa-phone"></i> 0706 277 227</a></li>
        ...
        <div class="header-upper">        
            <div class="auto-container">
				...
				<div class="main-box d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <!--Logo-->
                    <div class="logo-box">
                         <div class="logo"><a href="index.php" title="Delici - Restaurants HTML Template"><img src="images/logo1.png" alt="" title="Delici - Restaurants HTML Template"></a></div>
                    </div>
                        ...
                        <div class="nav-outer clearfix">         
                            <nav class="main-menu">
                                <ul class="navigation clearfix">
                                    ...
                                    <li><a href="#">Blog</a></li>
                                    <li><a href="customerSide/home/home.php">Contact</a></li>
                                    <li><a href="customerSide/home/home.php">Home</a></li>
                                </ul>
                            </nav>
                            <!-- Main Menu End-->
                        </div>
					...
					<div class="link link-btn">
						<a href="index.php" class="theme-btn btn-style-one clearfix">
							<span class="btn-wrap">
    ...
    <section class="hidden-bar">
        ...
        <div class="inner-box">
            ...
            <div class="logo-box"><a href="index.php" title=""><img src="images/logo1.png" alt="" title=""></a></div>
            ...
            <div class="side-menu">
                 <ul class="navigation clearfix">
                    <li class="current dropdown"><a href="index.php">Home</a>
                        <ul>
                            <li><a href="">Home 1 Left Header</a></li>
                            <li><a href="index.php">Home 1 Center Header</a></li>
                            <li><a href="">Home 3 Video Hero</a></li>
                        </ul>
                    </li>
            ...
            <h2>Visit Us</h2>
            <ul class="info">
                <li>Restaurant St, Delicious City, <br>Gampaha City</li>
            ...
            <div class="booking-info">
                ...
                <div class="bk-no"><a href="tel:0706 277 227">0706 277 227</a></div>
            </div>
    ...
    <section class="info-bar">
        <div class="inner-box">
            ...
            <div class="logo-box"><a href="index.php" title="Delici - Restaurants HTML Template"><img src="image/logo1.png" alt="" title="Delici - Restaurants HTML Template"></a></div>
    ...
    <section class="banner-section" style="display: none;">
        ...
        <div class="book-btn"><a href="reservation-contactform.html" class="theme-btn"><span class="icon"><img src="images/resource/book-icon-1.png" alt="" title=""></span><span class="txt">book a table</span></a></div>
    </section>
    <!--End Banner Section -->
    ...
    <section class="we-offer-section">
        ...
        <div class="auto-container">
            <div class="title-box centered">
                <div class="subtitle"><span>Royalty in Every Bite</span></div>
                <div class="pattern-image"><img src="images/icons/separator.svg" alt="" title=""></div>
                <h2>Experience Excellence</h2>
                <div class="text">Discover exquisite flavors and unmatched quality, redefining the art of exceptional dining.</div>
            </div>
            <div class="row justify-content-center clearfix">
                ...
                <div class="offer-block col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                        ...
                        <h3><a href="menu-list.html">Breakfast</a></h3>
                ...
                <div class="offer-block col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                        ...
                        <h3><a href="menu-list.html">Appetizers</a></h3>
                ...
                <div class="offer-block col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                        ...
                        <h3><a href="menu-list.html">Drinks</a></h3>
            ...
            <div class="row clearfix">
                ...
                <div class="content-col col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                        ...
                        <div class="price"><span class="old">Rs.400.00</span> <span class="new">Rs.450.00</span></div>
                        <div class="link-box">
                            <a href="menu-list-1.html" class="theme-btn btn-style-two clearfix">
                                <span class="btn-wrap">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            ...
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Greek Salad</a></h5></div><div class="price"><span>Rs.250.50</span></div></div>
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            ...
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Lasagne <span class="s-info">SEASONAL</span></a></h5></div><div class="price"><span>RS.440.00</span></div></div>
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            ...
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Butternut Pumpkin</a></h5></div><div class="price"><span>Rs.110.00</span></div></div>
                                ...
                                <div class="inner">
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            ...
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Tokusen Wagyu <span class="s-info">NEW</span></a></h5></div><div class="price"><span>Rs.439.00</span></div></div>
                                            <div class="text desc"><a href="#">Vegetables, cheeses, ground meats, tomato sauce, seasonings and spices.</a></div>
                                        </div>
                                    </div>
                                    <!--Block-->
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            ...
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Olivas Rellenas</a></h5></div><div class="price"><span>Rs.225.00</span></div></div>
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            ...
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Opu Fish</a></h5></div><div class="price"><span>Rs.549.00</span></div></div>
                                            <div class="text desc"><a href="#">Vegetables, cheeses, ground meats, tomato sauce, seasonings and spices</a></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="menu-col col-lg-6 col-md-12 col-sm-12">
                                <div class="inner">
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/menu-image-5.png" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Greek Salad</a></h5></div><div class="price"><span>Rs.525.50</span></div></div>
                                            <div class="text desc"><a href="#">Tomatoes, green bell pepper, sliced cucumber onion, olives, and feta cheese.</a></div>
                                        </div>
                                    </div>
                                    <!--Block-->
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/menu-image-6.png" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Lasagne <span class="s-info">SEASONAL</span></a></h5></div><div class="price"><span>Rs.840.00</span></div></div>
                                            <div class="text desc"><a href="#">Vegetables, cheeses, ground meats, tomato sauce, seasonings and spices</a></div>
                                        </div>
                                    </div>
                                    <!--Block-->
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/menu-image-7.png" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Butternut Pumpkin</a></h5></div><div class="price"><span>Rs.910.00</span></div></div>
                                            <div class="text desc"><a href="#">Typesetting industry lorem Lorem Ipsum is simply dummy text of the priand.</a></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="menu-col col-lg-6 col-md-12 col-sm-12">
                                <div class="inner">
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/menu-image-8.png" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Tokusen Wagyu <span class="s-info">NEW</span></a></h5></div><div class="price"><span>Rs.939.00</span></div></div>
                                            <div class="text desc"><a href="#">Vegetables, cheeses, ground meats, tomato sauce, seasonings and spices.</a></div>
                                        </div>
                                    </div>
                                    <!--Block-->
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/menu-image-9.png" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Olivas Rellenas</a></h5></div><div class="price"><span>Rs.425.00</span></div></div>
                                            <div class="text desc"><a href="#">Avocados with crab meat, red onion, crab salad stuffed red bell pepper and  green bell pepper.</a></div>
                                        </div>
                                    </div>
                                    <!--Block-->
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/menu-image-10.png" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Opu Fish</a></h5></div><div class="price"><span>Rs.849.00</span></div></div>
                                            <div class="text desc"><a href="#">Vegetables, cheeses, ground meats, tomato sauce, seasonings and spices</a></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="menu-col col-lg-6 col-md-12 col-sm-12">
                                <div class="inner">
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/menu-image-7.png" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Butternut Pumpkin</a></h5></div><div class="price"><span>Rs.1110.00</span></div></div>
                                            <div class="text desc"><a href="#">Typesetting industry lorem Lorem Ipsum is simply dummy text of the priand.</a></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="menu-col col-lg-6 col-md-12 col-sm-12">
                                <div class="inner">
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/menu-image-8.png" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Tokusen Wagyu <span class="s-info">NEW</span></a></h5></div><div class="price"><span>Rs.539.00</span></div></div>
                                            <div class="text desc"><a href="#">Vegetables, cheeses, ground meats, tomato sauce, seasonings and spices.</a></div>
                                        </div>
                                    </div>
                                    <!--Block-->
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/menu-image-9.png" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Olivas Rellenas</a></h5></div><div class="price"><span>Rs.525.00</span></div></div>
                                            <div class="text desc"><a href="#">Avocados with crab meat, red onion, crab salad stuffed red bell pepper and  green bell pepper.</a></div>
                                        </div>
                                    </div>
                                    <!--Block-->
                            ...
                            <div class="menu-col col-lg-6 col-md-12 col-sm-12">
                                <div class="inner">
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/menu-image-6.png" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Lasagne <span class="s-info">SEASONAL</span></a></h5></div><div class="price"><span>Rs.940.00</span></div></div>
                                            <div class="text desc"><a href="#">Vegetables, cheeses, ground meats, tomato sauce, seasonings and spices</a></div>
                                        </div>
                                    </div>
                                    <!--Block-->
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/menu-image-7.png" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Butternut Pumpkin</a></h5></div><div class="price"><span>Rs,710.00</span></div></div>
                                            <div class="text desc"><a href="#">Typesetting industry lorem Lorem Ipsum is simply dummy text of the priand.</a></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="menu-col col-lg-6 col-md-12 col-sm-12">
                                <div class="inner">
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/menu-image-8.png" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Tokusen Wagyu <span class="s-info">NEW</span></a></h5></div><div class="price"><span>Rs.739.00</span></div></div>
                                            <div class="text desc"><a href="#">Vegetables, cheeses, ground meats, tomato sauce, seasonings and spices.</a></div>
                                        </div>
                                    </div>
                                    <!--Block-->
                ...
                <div class="reserv-col col-lg-8 col-md-12 col-sm-12">
                    <div class="inner">
                        <div class="title">
                            ...
                            <div class="request-info">Booking request <a href="#">0706 277 227</a> or fill out the order form</div>
                        </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="form-group col-lg-4 col-md-6 col-sm-12">
                                        <div class="field-inner">
                                            ...
                                            <select name="num_persons" class="l-icon" required>
                                    ...
                                    <div class="form-group col-lg-4 col-md-6 col-sm-12">
                                        <div class="field-inner">
                                            ...
                                            <input class="l-icon datepicker" type="text" name="reservation_date" value="" placeholder="DD-MM-YYYY" required readonly>
                                            <span class="arrow-icon far fa-angle-down"></span>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-4 col-md-12 col-sm-12">
                                        <div class="field-inner">
                                            ...
                                            <select name="reservation_time" class="l-icon" required>
                ...
                <div class="info-col col-lg-4 col-md-12 col-sm-12">
                    <div class="inner">
                        ...
                        <div class="data">
                            ...
                            <div class="separator"><span></span></div>
                            <ul class="info">
                                <li><strong>Location</strong><br>Mom's touch luxury Restaurant & Banquet hall</li>
            ...
            <div class="row justify-content-center clearfix">
                ...
                <div class="team-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                        ...
                        <h3><a href="menu-list.html">Karunarathna</a></h3>
                ...
                <div class="team-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                        ...
                        <h3><a href="menu-list.html">Weerathunga</a></h3>
                        <div class="designation">Master chef</div>
                        <div class="text desc"></div>
                    </div>
                </div>
                ...
                <div class="team-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                        ...
                        <h3><a href="menu-list.html">Diwyanka</a></h3>
                        <div class="designation">Master chef</div>
                        <div class="text desc"></div>
                    </div>
                </div>
    ...
    <footer class="main-footer">
                    ...
                    <div class="footer-col info-col col-lg-6 col-md-12 col-sm-12">
                        <div class="inner wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="content">
                                ...
                                <div class="info">
                                    <ul>
                                        <li>Mom's touch luxury Restaurant & Banquet hall</li>
                                        <li><a href="mailto:booking@domainname.com">booking@domainname.com</a></li>
                                        <li><a href="tel:0706 277 227">Booking Request : 0706 277 227</a></li>
                                ...
                                <div class="newsletter">
                                    ...
                                    <div class="newsletter-form">
                                        <form method="post" action="https://kalanidhithemes.com/live-preview/landing-page/delici/all-demo/Delici-Video-Hero-Center-Header/index.php">
        ...
        <div class="footer-bottom">
            <div class="auto-container">
                <div class="copyright">&copy; 2022 Restaurt. All Rights Reserved   |    Crafted by <a href="https://nexarasolutions.site" target="blank">Nexara Solutions</a></div>
            </div>
        </div>
        <div class="link link-btn">
						<a href="customerSide/home/home.php" class="theme-btn btn-style-one clearfix">
							<span class="btn-wrap">
