...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="../panel/pos-panel.php">Mom's touch Staff Panel</a>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        if ($_SESSION['roll'] != 1 && $_SESSION['roll'] != 4) {
                        ?>
                        ...
                        if ($_SESSION['roll'] != 1 && $_SESSION['roll'] != 4 && $_SESSION['roll'] != 5) {
                        ...
                        ?>
                            <a class="nav-link" href="../panel/report.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-eye"></i></div>
                                Report
                            </a>
                        <?php
