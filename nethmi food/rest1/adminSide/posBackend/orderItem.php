...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            Bill has already been paid.
                            ...
                            if ($_SESSION['roll'] != 1) {
                                echo '<br><a href="receipt.php?bill_id=' . $bill_id . '" target="_blank" class="btn btn-light">Print Receipt <span class="fa fa-receipt text-black"></span></a></div>';
                            }
                        } elseif (($tax * $cart_total + $cart_total) > 0) {
                            if ($_SESSION['roll'] != 1) {
                                echo '<br><a href="idValidity.php?bill_id=' . $bill_id . '" class="btn btn-success" onclick="oderconformed(' . $bill_id . ');">Pay Bill</a>';
                            }
                        } else {
    ...
    x.open("GET", "updatebilliddata.php?id=" + encodeURIComponent(id), true);
    x.send();
}
